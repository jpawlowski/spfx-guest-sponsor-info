define([], function() {
  return {
    ...
    "AuthorSectionGroupName": "発行元について",
    "AuthorSectionIntro": "Workoho GmbH：安全でスケーラブルな M365 コラボレーションのためのコンサルティング。",
    "AuthorSectionWebsiteLinkLabel": "Workoho にコンサルティングを依頼",
    "AuthorSectionConsultingText": "ガバナンス、B2B ゲストアクセス、ID、コラボレーションプロセスを支援し、チーム作業を安全・監査可能・効率的に保ちます。",
    "AuthorSectionPartnerPrefix": "Workoho は",
    "AuthorSectionPartnerLinkLabel": "EasyLife 365",
    "AuthorSectionPartnerSuffix": "Platinum 販売パートナーです。",
    "AuthorSectionPartnerTagline": "EasyLife 365 により、アクセスワークフローを自動化し、複雑な Microsoft 365 環境を整理できます。",
