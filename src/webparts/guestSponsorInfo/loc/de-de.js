...
define([], function() {
  return {
    ...
    "WelcomeDialogDoneApiSkippedBody": "Es wurden keine Zugangsdaten eingegeben. Öffnen Sie die Einstellungen des Web Parts, um die Guest Sponsor API zu verbinden, sobald Sie bereit sind.",
