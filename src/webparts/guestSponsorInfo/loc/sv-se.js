define([], function() {
  return {
    ...
    "AuthorSectionGroupName": "Om utgivaren",
    "AuthorSectionIntro": "Workoho GmbH: rådgivning för säkert och skalbart M365-samarbete.",
    "AuthorSectionWebsiteLinkLabel": "Kontakta Workoho för rådgivning",
    "AuthorSectionConsultingText": "Vi hjälper till med governance, B2B-gäståtkomst, identiteter och samarbetsprocesser så att samarbetet förblir säkert, granskningsbart och effektivt.",
    "AuthorSectionPartnerPrefix": "Workoho är",
    "AuthorSectionPartnerLinkLabel": "EasyLife 365",
    "AuthorSectionPartnerSuffix": "Platinum-säljpartner.",
    "AuthorSectionPartnerTagline": "Med EasyLife 365 automatiserar du åtkomstflöden och skapar ordning i komplexa Microsoft 365-miljöer.",
